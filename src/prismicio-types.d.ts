...
/**
 * Primary content in *MagicalSlice → Primary*
 */
export interface MagicalSliceSliceDefaultPrimary {
	/**
	 * Rich Text field in *MagicalSlice → Primary*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: magical_slice.primary.rich_text
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	rich_text: prismic.RichTextField;

	/**
	 * Image field in *MagicalSlice → Primary*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: magical_slice.primary.image
	 * - **Documentation**: https://prismic.io/docs/field#image
	 */
	image: prismic.ImageField<never>;
}
...
/**
 * Default variation for MagicalSlice Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type MagicalSliceSliceDefault = prismic.SharedSliceVariation<
	'default',
	Simplify<MagicalSliceSliceDefaultPrimary>,
	never
>;

/**
 * Slice variation for *MagicalSlice*
 */
type MagicalSliceSliceVariation = MagicalSliceSliceDefault;

/**
 * MagicalSlice Shared Slice
 *
 * - **API ID**: `magical_slice`
 * - **Description**: MagicalSlice
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type MagicalSliceSlice = prismic.SharedSlice<'magical_slice', MagicalSliceSliceVariation>;
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			...
			MagicalSliceSlice,
			MagicalSliceSliceDefaultPrimary,
			MagicalSliceSliceVariation,
			MagicalSliceSliceDefault,
			QuoteSlice,
